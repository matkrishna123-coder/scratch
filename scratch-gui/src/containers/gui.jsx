...
const mapStateToProps = state => {
    ...
    return {
        ...
        boardModalVisible: state.scratchGui.modals.boardModal,
...
const mapDispatchToProps = dispatch => ({
    ...
    onRequestCloseBoardModal: () => dispatch(closeBoardModal()),
    onRequestCloseConnectModal: () => dispatch(closeConnectModal()),
