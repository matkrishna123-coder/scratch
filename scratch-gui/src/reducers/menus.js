...
const MENU_CONNECT = 'connectMenu';
...
const rootMenu = new Menu('root')
    ...
    .addChild(new Menu(MENU_BOARD))
    .addChild(new Menu(MENU_CONNECT))
...
const connectMenuOpen = state => state.scratchGui.menus[MENU_CONNECT];
