...
import {openTipsLibrary, openDebugModal, openBoardModal, openConnectModal} from '../../reducers/modals';
            ...
            >
                <div className={styles.mainMenu}>
                    <div className={styles.fileGroup}>
                        ...
                        >
                            <span className={styles.collapsibleLabel}>
                                <FormattedMessage
                                    ...
                                    description="Text for board menu item"
                        ...
                        <div
                            className={classNames(styles.menuBarItem, styles.hoverable)}
                            onMouseUp={this.props.onClickConnect}
                        >
                            <span className={styles.collapsibleLabel}>
                                <FormattedMessage
                                    defaultMessage="Connect"
                                    description="Text for connect menu item"
...
const mapDispatchToProps = dispatch => ({
    ...
    onClickBoard: () => dispatch(openBoardModal()),
    onClickConnect: () => dispatch(openConnectModal())
});
